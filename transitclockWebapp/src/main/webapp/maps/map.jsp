...
L.tileLayer(mapTileUrl, {
    ...
    attribution: '&copy; <a href="http://openstreetmap.org">OpenStreetMap</a> &amp; <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery &copy; <%= WebConfigParams.getMapTileCopyright() %>',
    maxZoom: 19
}).addTo(map);
