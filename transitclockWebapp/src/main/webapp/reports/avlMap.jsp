...
window.transitclockMapTileUrl = '<%= WebConfigParams.getMapTileUrl() %>';
window.transitclockMapTileCopyright = '<%= WebConfigParams.getMapTileCopyright() %>';
</script>
<script src="<%= request.getContextPath() %>/map/javascript/avlMap.js?v=2"></script>
</html>
