...
<%
  ...
  pageContext.setAttribute("chartSubtitle", chartSubtitle);
  pageContext.setAttribute("allowableEarly", allowableEarly);
  pageContext.setAttribute("allowableLate", allowableLate);
  pageContext.setAttribute("ajaxDataString", WebUtils.getAjaxDataString(request));
  pageContext.setAttribute("routeIdParam", request.getParameter("r"));
%>
<t:layout>
...
function getDataAndDrawChart() {
	...
	$.getJSON(apiUrlPrefix + "/command/routes?r=${routeIdParam}",
			  determineChartTitle);
